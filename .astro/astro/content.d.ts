...
"daily/2026-06-01.md": {
	id: "daily/2026-06-01.md";
  slug: "daily/2026-06-01";
  body: string;
  collection: "en";
  data: any
} & { render(): Render[".md"] };
"daily/2026-06-02-btc-eth-analysis.md": {
	id: "daily/2026-06-02-btc-eth-analysis.md";
  slug: "daily/2026-06-02-btc-eth-analysis";
  body: string;
  collection: "en";
  data: any
} & { render(): Render[".md"] };
"daily/2026-06-02.md": {
	id: "daily/2026-06-02.md";
